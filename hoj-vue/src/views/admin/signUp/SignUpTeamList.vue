        ...
        <el-card shadow>
          ...
          <el-row>
            <el-col :xs="24" :sm="24" :md="2" :lg="2">
              <span class="panel-title home-title">{{ $t('m.All') }}{{ $t('m.SignUp') }}</span>
            </el-col>
                ...
                <el-row type="flex" justify="space-between" align="middle">
                  <el-col :xs="18" :sm="18" :md="20" :lg="20" class="contest-main">
                    <div style="padding: 0 10px;">
                      <p
                        class="title"
                        @click="showTeamInfo(signUpItem.id)"
  ...
  methods: {
    ...
    getborderColor(signUpItem) {
      if (signUpItem.teamType === 1) {
        return "padding: 0 5px;border-radius:15px;border-left: 4px solid #ff99cb";
      } else {
        return "padding: 0 5px;border-radius:15px;border-left: 4px solid #2ea7e0";
