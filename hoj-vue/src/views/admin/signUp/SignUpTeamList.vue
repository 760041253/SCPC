    ...
    <div>
        ...
        <el-col :span="24">
          <el-card shadow>
              ...
              <el-row>
                ...
                <el-col v-if="isSuperAdmin" :xs="24" :sm="24" :md="18" :lg="18">
                  <span style="line-height: 2rem;">
                    ...
                    >
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item command="0">{{$t('m.All')}}
                        </el-dropdown-item>
                ...
                <el-col v-if="isSuperAdmin==false" :xs="24" :sm="24" :md="18" :lg="18">
                  <span style="line-height: 2rem;">
                    <el-dropdown
                      @command="onStatusChange"
                      placement="bottom"
                ...
                <el-col v-if="isSuperAdmin" :xs="24" :sm="24" :md="4" :lg="4">
              ...
              <div v-loading="loading">
                ...
                <ol id="sign-up-list">
                  <li v-for="signUpItem in signUpList" :key="signUpItem.id"  :style="getborderColor(signUpItem)">
                    <el-row type="flex" justify="space-between" align="middle">
                      <el-col :xs="18" :sm="18" :md="20" :lg="20" class="contest-main" >
                        <div style="padding: 0 10px;">
                          <p class="title" @click="showTeamInfo(signUpItem.id)" style="cursor: pointer;">
                          {{  signUpItem.teamName }} | {{signUpItem.englishTeamName}} 
                          &emsp;&emsp;
                          <span v-if="signUpItem.teamType===1" style="margin-top: 2px;font-size: 10px;" class="contest-rank-flag">Girl</span>
                          </p>
                          <div>
                            <el-row>
                              <el-col :xs="24" :sm="24" :md="8" :lg="8" style="font-size: 1rem;">
                                <el-row>
                                  <el-col :xs="24" :sm="24" :md="6" :lg="5">
                                    <span style="font-weight: 600;font-size: 1rem;">{{$t('m.MemberOne')}}</span>  
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="6" :lg="5" style="text-align: center;">
                                    {{ signUpItem.teammatesName.split("-")[0] }}
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="6" :lg="7" style="text-align: center;">
                                    {{ signUpItem.studentId.split("-")[0] }}
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="6" :lg="6" style="text-align: center;">
                                    {{ signUpItem.studentClass.split("-")[0] }}
                                  </el-col>
                                </el-row>
                              </el-col>
                              <el-col :xs="24" :sm="24" :md="8" :lg="8"  style="font-size: 1rem;"
                              v-show="signUpItem.teammatesName.split('-')[1]!='*'">
                                <el-row>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="5">
                                    <span style="font-weight: 600;font-size: 1rem;">{{$t('m.MemberTwo')}}</span>
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="5" style="text-align: center;">
                                    {{ signUpItem.teammatesName.split("-")[1] }}
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="7" style="text-align: center;">
                                    {{ signUpItem.studentId.split("-")[1] }}
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="6" style="text-align: center;">
                                    {{ signUpItem.studentClass.split("-")[1] }}
                                  </el-col>
                                </el-row>
                              </el-col>
                              <el-col :xs="24" :sm="24" :md="8" :lg="8" style="font-size: 1rem;"
                              v-show="signUpItem.teammatesName.split('-')[2]!='*'"> 
                                <el-row>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="5">
                                    <span style="font-weight: 600;font-size: 1rem;">{{$t('m.MemberThree')}}</span>
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="5" style="text-align: center;">
                                    {{ signUpItem.teammatesName.split("-")[2] }}
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="7" style="text-align: center;">
                                    {{ signUpItem.studentId.split("-")[2] }}
                                  </el-col>
                                  <el-col :xs="24" :sm="24" :md="8" :lg="6" style="text-align: center;">
                                    {{ signUpItem.studentClass.split("-")[2] }}
                                  </el-col>
                                </el-row>
                              </el-col>
                            </el-row>
                      ...
                      <el-col :xs="6" :sm="6" :md="3" :lg="4" style="text-align: center" >
                      ...
                      &emsp;&emsp;&emsp;&emsp;
                      <el-tag  effect="dark" :color="SIGN_UP_TYPE['1']['color']"
                        size="medium" v-if="signUpItem.star==1" >
                        <i class="fa el-icon-star-on" aria-hidden="true"></i>
                        {{ $t('m.' + SIGN_UP_TYPE['1']['name']) }}
                      </el-tag>
                      <el-tag  effect="dark" :color="SIGN_UP_TYPE['0']['color']"
                        size="medium" v-else >
      ...
      :before-close="handleClose">
        <div style="margin-top: -30px;">
          ...
          <el-checkbox v-model="checked" :label="$t('m.EnglishTeamName')" disabled border size="medium"></el-checkbox>
          <br><h3>{{$t('m.Choose_Export_Info_Tip_Else')}}</h3>
          ...
          <div style="text-align: center;padding: 20px 0 0 0;">
            <el-button type="primary" size="medium" plain
              @click.stop="exportToCsv()" style="width: 200px;"
...
export default {
  ...
  methods:{
    ...
    getTeamList(){
        this.loading = true;
        api.getTeamInfoPageByContestId(
            this.status,
    ...
    showTeamInfo(id){
      this.teamid = id
      api.getTeamInfoById(this.teamid).then(
        (res)=>{
