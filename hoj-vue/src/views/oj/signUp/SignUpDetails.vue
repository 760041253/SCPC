                    ...
                    <el-row>
                      ...
                      <el-col v-if="isSuperAdmin" :xs="24" :sm="24" :md="3" :lg="3">
                        <el-button type="success"  size="medium" plain
                          @click.stop="chooseExportInfo(signUpContestId)"  style="margin-left: 30px;"
                        >{{$t('m.One_Click_Export')}}</el-button>
                        <span></span>
                      </el-col>
                      <el-col :xs="24" :sm="24" :md="3" :lg="3">
                        <el-button v-if="isSignUp==false" type="primary" size="medium" plain
                          @click.stop="toSignUpInfo(signUpContestId)"  style="margin-left: 40px;"
                        >{{$t('m.SignUpContest')}}</el-button>
                        <el-button v-if="isSignUp==true" type="primary" size="medium" plain
                          @click.stop="toSignUpInfo(signUpContestId)" style="margin-left: 40px;"
                ...
                <div v-loading="loading">
                  ...
                  <ol id="sign-up-list">
                    <li v-for="signUpItem in signUpList" :key="signUpItem.id"  :style="getborderColor(signUpItem)">
                      <el-row type="flex" justify="space-between" align="middle" style="padding: 0 10px 0 0">
                            ...
                            <div>
                              <el-row>
                                ...
                                v-show="signUpItem.teammatesName.split('-')[2]!='*'"> 
                                  <el-row>
                                    <el-col :xs="24" :sm="24" :md="8" :lg="5">
                                      <span style="font-weight: 600;font-size: 1vw;">{{$t('m.MemberThree')}}</span>
                                    </el-col>
                                    <el-col :xs="24" :sm="24" :md="8" :lg="5" style="text-align: center;">
  ...
  methods:{
    ...
    getborderColor(signUpItem) {
      if(signUpItem.teamType===1){
        return (
          'padding: 0 5px;border-left: 4px solid #ff99cb'
