export const m = {
  ...
  Official: '正式',
  Accept: 'Accept',
  Apply_For_Update: 'Update',
  Pending: 'Pending',
  Reject: 'Reject',
  Max_Participants_Unit: '人',
  SignUpContest: '报名比赛',
  SignUpModify: '我的报名',
  SignUpStatus: '筛选报名状态',
  One_Click_Export: '一键导出AC队伍信息',
  Choose_Export_Info: '选择需要导出的队伍信息',
  Choose_Export_Info_Tip: '默认导出信息',
  Choose_Export_Info_Tip_Else: '可选导出信息',
  Team_Account: '队伍账号',
  Team_Password: '队伍密码',
  Team_Member_Name: '队员姓名',
  Team_Member_Id: '队员学号',
  Team_Member_Class: '队员班级',
  Team_Member_Size: '队员衣服尺码',
  Team_Member_Phone: '队员电话号码',
  Team_Member_Account: '队员SCPC账号',
  Admire_Export: '确认导出',
  Team_Is_Girls: '是否女队',
  DwonloadIng: '正在下载，请稍等',
  AC_Team_Count: '已AC队伍',

  // /views/oj/sign-up/SignUpInfo/SignUpInfo.vue
  SignUpInfoTitle: '填写队伍信息',
  SignUpState: '报名状态',
  SignItem: '队伍',
  IsCaptain: '你是队长',
  TeamName: '队伍中文名',
  EnglishTeamName: '队伍英文名',
  TeammatesName: '姓名',
  StudentId: '学号',
  StudentClass: '班级',
  PhoneNumber: '手机号',
  ...
  MemberInfo: '队员个人信息',
  AddMember: '添加队员',
  CanNotAddMember: '队员已达上限',
  SubMember: '删除队员',
  MemberOne: '队长',
  MemberTwo: '队员二',
  MemberThree: '队员三',
  TeamName_Check_Required: '请输入队伍名称',
  English_TeamName_Check_Required: '请输入队伍英文名称',
  TeammatesName_Check_Required: '请填写队员名字',
  StudentClass_Check_Required: '请填写队员班级',
  StudentId_Check_Required: '请填写队员学号',
  UsersName_Check_Required: '请填写队员账号名',
  PhoneNumber_Check_Required: '请填写队员电话',
  Size_Check_Required: '请填写队员上衣尺寸',
  Gender_Check_Required: '请选择队员性别',
  Sign_Up_Btn: '确认报名',
  Sign_up_Success: '报名成功',
  SignUpInfo_Modify: '编辑队伍信息',
  SignUpInfo_View: '查看队伍信息',
  Sign_Up_Modify_Btn: '完成修改',
  Sign_Up_Modify: '队伍已通过审核，确定修改?',
  Sign_up_Modify_Success: '修改成功',
  Sign_up_Modify_Dialog_Title: '提交修改申请',
  Sign_up_Modify_Dialog_Info: '你的队伍已经审核通过，再次修改信息需要发出申请',
