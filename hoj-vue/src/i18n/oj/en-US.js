export const m = {
  ...
  // /views/oj/sign-up/SignUpDetails/SignUpDetails.vue
  SignUp: 'SignUp',
  No_Sign_Up: 'No Sign Up',
  Star: 'Star',
  Official: 'Official',
  Accept: 'Accept',
  Apply_For_Update: 'Apply For Update',
  Pending: 'Pending',
  Reject: 'Reject',
  Max_Participants_Unit: 'Member',
  SignUpContest: 'Sign Up',
  SignUpModify: 'Modify Info',
  SignUpStatus: 'Screening SignUp status',
  One_Click_Export: 'One click export',
  Choose_Export_Info: 'Select the team information that you want to export',
  Choose_Export_Info_Tip: 'Default export information',
  Choose_Export_Info_Tip_Else: 'Optional Export information',
  Team_Account: 'Team account',
  Team_Password: 'Team password',
  Team_Member_Name: 'Team name',
  Team_Member_Id: 'Team id',
  Team_Member_Class: 'Team class',
  Team_Member_Size: 'Team size',
  Team_Member_Phone: 'Team phone',
  Team_Member_Account: 'Team SCPC account',
  Admire_Export: 'Confirm Export',
  Team_Is_Girls: 'Is women',
  DwonloadIng: 'Please wait for a moment while downloading',
  AC_Team_Count: 'Passed Teams',

  // /views/oj/sign-up/SignUpInfo/SignUpInfo.vue
  SignUpInfoTitle: 'Fill in the team information',
  SignUpState: 'Sign up Status',
  SignItem: 'Team',
  IsCaptain: 'Captain',
  TeamName: 'Team name',
  EnglishTeamName: 'English team name',
  TeammatesName: 'Teammates name',
  ...
  MemberInfo: 'Teammates information',
  AddMember: 'Add A Member',
  CanNotAddMember: 'The number of members has reached the upper limit',
  SubMember: 'Delete A Member',
  MemberOne: 'Member one',
  MemberTwo: 'Member two',
  MemberThree: 'Member three',
  TeamName_Check_Required: 'Please enter the team name',
  English_TeamName_Check_Required: 'Please enter the English name of the team',
  TeammatesName_Check_Required: 'Please fill in the names of the teammate',
  StudentClass_Check_Required: 'Please fill in the teammate class',
  StudentId_Check_Required: 'Please fill in the teammate id',
  UsersName_Check_Required: 'Please fill in the teammate account',
  PhoneNumber_Check_Required: 'Please fill in the teammate phone number',
  Size_Check_Required: 'Please fill in the size of the shirt',
  Gender_Check_Required: 'Please select the gender of the teammate',
  Sign_Up_Btn: 'Confirm SignUp',
  Sign_up_Success: 'SignUp Success',
  SignUpInfo_Modify: 'Edit team information',
  Sign_Up_Modify_Btn: 'Complete Modification',
  Sign_Up_Modify: 'Has the team passed the audit and confirmed the modification?',
  Sign_up_Modify_Success: 'Modify Successfully',
  Sign_up_Modify_Dialog_Title: 'Submit an amendment request',
  Sign_up_Modify_Dialog_Info: 'Your team has passed the examination, and the application needs to be issued to modify the information again',
