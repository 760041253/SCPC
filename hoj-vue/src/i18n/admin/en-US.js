export const m = {
  ...
  Create_SignUp:'Create SignUp',
  SignUp_List:'SignUp List',
  Edit_SignUp:'Edit SignUp',
  SignUp_Contest:'Contest Id',
  SignUp_Type:'Contest Type',
  SignUp_Start_Time:'SignUp Start Time',
  SignUp_End_Time:'SignUp End Time',
  SignUp_Duration:'SignUp Duration',
  Max_Participants:'Max Participants',
  SignUp_Title_Check_Required:'Please fill in the registration title',
  SignUp_Contest_Check_Required:'Please fill in the competition ID',
  SignUp_Start_Time_Check_Required:'Please fill in the start time',
  SignUp_End_Time_Check_Required:'Please fill in the end time',
  Max_Participants_Check_Required:'Please fill in the maximum number of team members',
  ContestType_Check_Required:'Please select the format',
  Add_Sign_Up_Success:'Add Sign Up Success',
  Update_Sign_Up_Success:'Update Sign Up Success',
  View_SignUp_List:'View SignUp List',
  signUpTeam_List:'signUpTeam List',
  AC_Team_Count:'AC Team Count',
  Delete_SignUp_Tips: 'This operation will delete the registration and the application status of the registration team. Do you want to continue?',
