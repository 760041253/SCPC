export const m = {
  ...
  SignUp_Contest: '比赛ID',
  SignUp_Type: '比赛类型',
  SignUp_Start_Time: '开始时间',
  SignUp_End_Time: '结束时间',
  SignUp_Duration: '报名时长',
  Max_Participants: '单只队伍成员上限',
  SignUp_Title_Check_Required: '请填写报名标题',
  SignUp_Contest_Check_Required: '请填写比赛ID',
  SignUp_Start_Time_Check_Required: '请选择开始时间',
  SignUp_End_Time_Check_Required: '请选择结束时间',
  ...
  Delete_SignUp_Tips: '此操作将删除该报名以及报名队伍的申请状态等数据, 是否继续?',
