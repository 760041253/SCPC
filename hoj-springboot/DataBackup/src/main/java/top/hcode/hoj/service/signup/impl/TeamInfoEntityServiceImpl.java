...
//        return CommonResult.successResponse(teamInfoVOS);
    ...
    @Override
    public void generateCsvByContestId(Long cid, Long choose, HttpServletResponse response) throws StatusFailException, StatusForbiddenException, IOException {
